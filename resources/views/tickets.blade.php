...
<div class="container">
    <div class="infoblock">
        除@foreach($games as $data)<a href="{{ url('games/'.$data->game) }}">{{ $data->name }}</a>@if(!$loop->last)、@endif @endforeach外，<br/>
