    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="row">
                ...
                <a href="{{ url('games/'.$game->game) }}" class="btn btn-success" role="button">查看前端頁面</a>
                </div>
            </div>
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ url('/m/games/'.$game->id) }}">
                        ...
                        <div class="form-group">
                            <label for="is_ticket" class="col-md-4 control-label">是否發票</label>
                        ...
                        <div class="form-group">
                            <label for="is_broadcast" class="col-md-4 control-label">是否轉播</label>
