...
<section class="gameboard">
    <div class="container">
        ...
        <div class="gameboard-content">
            <div class="team">
                <div class="team-logo">
                    @if($game->team_nthu==NULL || $game->team_nthu->logo==NULL)
                    ...
                    @else
                    <img src="{{ asset('images/'.$game->team_nthu->logo) }}">
                    @endif
                </div>
                <div>
            ...
            <div class="team">
                <div class="team-logo">
                    @if($game->team_nctu==NULL || $game->team_nctu->logo==NULL)
...
<div class="container">
    ...
    <section>
        ...
        <div class="game-history">
            <div class="team team-nthu team-left">
            ...
            <div class="team team-nctu team-right">
                <div class="team-percent">
