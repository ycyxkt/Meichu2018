                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="account" class="form-control" name="email" value="{{ old('email') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('group') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="group" type="group" class="form-control" name="group" value="{{ old('group') }}" required>
